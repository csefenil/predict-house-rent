...
ds.columns = ['Area', 'BHK', 'Bathroom', 'Furnishing', 'Locality', 'Parking', 'Transaction', 'Type', 'Per_Sqft',
              'Total_Sqft', 'Rent']
ds.info(), ds
...
#df = ds[
#    ['Area', 'BHK', 'Bathroom', 'Furnishing', 'Locality', 'Parking', 'Transaction', 'Type', 'Per_Sqft', 'Total_Sqft',
#     'Rent']]
df = ds[
    ['Area', 'BHK', 'Bathroom', 'Furnishing', 'Parking', 'Transaction', 'Type', 'Per_Sqft', 'Total_Sqft',
     'Rent']]
df = df.fillna(0)
df.Area.astype(int)
...
print(model.predict([[900,2,2,1,1,1,1,190,900]]))
